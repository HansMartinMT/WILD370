...
VegetationType<-as.factor(sample.int(5, 25, replace=TRUE)) # Randomly generates vegetation types that the camera traps may be located in
...
SimCamData<-data.frame(CameraID,VegetationType,TrailPresent,DistanceToEdge,DistanceToStream)
